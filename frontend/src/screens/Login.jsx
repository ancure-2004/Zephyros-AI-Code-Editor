...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen flex flex-col md:flex-row bg-black text-white">
      ...
      {/* Left Side - Form */}
      <div className="w-full md:w-1/2 flex flex-col justify-center px-6 md:px-20 py-10 relative">
        {/* Back Button */}
        <Link to="/" className="absolute top-4 left-4 flex items-center text-gray-400 hover:text-white transition-colors duration-300 group">
        ...
        <div className="mb-6 animate-fade-in">
          <div className="flex items-center mb-3">
            <img src="./logo.png" alt="Zephyros Logo" className="h-8 w-20 mr-2"/>
          </div>
        ...
        <form onSubmit={submitHandler} className="space-y-3">
          <div>
            ...
            <input type="email" value={email} onChange={(e)=>setEmail(e.target.value)} placeholder="Your email address"
              className="w-full px-3 py-2 bg-gray-900 border border-gray-700 rounded-lg focus:outline-none focus:ring-2 focus:ring-purple-600 placeholder-gray-500 text-sm"/>
          </div>
          ...
          <div>
            ...
            <div className="relative">
              <input type={showPassword?"text":"password"} value={password} onChange={(e)=>setPassword(e.target.value)} placeholder="Your password"
                className="w-full px-3 py-2 bg-gray-900 border border-gray-700 rounded-lg focus:outline-none focus:ring-2 focus:ring-purple-600 placeholder-gray-500 pr-10 text-sm"/>
      ...
      <div className="hidden md:block w-1/2 relative">
        <img src="./fc1e4bf3b1d22fd8416cbd243247f619.jpg" alt="Login Illustration" className="w-full h-full object-cover"/>
      </div>
